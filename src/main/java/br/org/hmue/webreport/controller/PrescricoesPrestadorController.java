 ...
 * @author Gleywson
 */
@Named(value = "prescricoesPrestadorController")
@RequestScoped
public class PrescricoesPrestadorController {
    ...
    public void emitirToExcel() {
        try {
            ...
            ExecutorRelatorio executor = new ExecutorRelatorio("/relatorios/prescricaoPorEspecialidade.jasper",
                    this.response, parametros, "prescricoes_por_especialidade.xls");
